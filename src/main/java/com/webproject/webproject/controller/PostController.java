...
import com.webproject.webproject.service.PostService;
...
public class PostController {
	...
	@GetMapping
	public List<PostResponse> getAllPosts(@RequestParam Optional<Long> userId){ //because /posts?userId={userId}
